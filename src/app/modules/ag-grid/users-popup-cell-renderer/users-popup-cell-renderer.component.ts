...
@Component({
  selector: 'app-users-popup-cell-renderer',
  templateUrl: './users-popup-cell-renderer.component.html',
  styleUrls: ['./users-popup-cell-renderer.component.scss'],
})
export class UsersPopupCellRendererComponent implements AfterViewInit {
  private params: any;
